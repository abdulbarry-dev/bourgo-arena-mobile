...
void main() {
  ...
  late UpdateFamilyMemberUseCase useCase;

  setUp(() {
    repository = MockFamilyRepository();
    useCase = UpdateFamilyMemberUseCase(repository);
  });

  test('calls repository.updateFamilyMember and returns the result', () async {
    ...
    expect((result as Success).data.name, 'Sara Ben Ali Updated');
  });
}
