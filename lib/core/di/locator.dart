...
import 'package:bourgo_arena_mobile/data/services/push_notification_service.dart';
...
Future<void> initLocator() async {
  ...
  // SettingsRepository adapter removed — consumers should use
  // SessionRepository directly.

  // Push Notifications Service
  locator.registerLazySingleton<PushNotificationService>(
    () => FirebaseMessagingService(locator<SessionRepository>()),
  );
